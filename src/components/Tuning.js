  ...
  return (
    <section className="bg-slate-700 text-white py-16 shadow-xl rounded-xl sm:m-2 md:m-8">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center flex-col space-y-4 md:flex-row md:space-x-8 md:space-y-0 mx-auto"> 
          <div className="relative w-60 h-60 rounded-3xl overflow-hidden mx-auto"> 
        ...
        <button onClick={handleClickServices}
          className="bg-slate-500 hover:bg-teal-600 text-white py-2 px-6 rounded-full font-semibold text-lg mt-8 md:mt-0"> 
          Get Started
        </button>
      </div>
    </section>
