...
const About = () => {
  return (
    <section className="bg-slate-700 text-white px-4 py-8 md:py-16 shadow-xl rounded-xl sm:m-2 md:m-8 flex flex-col md:flex-row items-center transition duration-300 transform hover:scale-105">
